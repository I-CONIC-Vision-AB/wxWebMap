...
bool wxWebMapApp::OnInit()
{
    ...
    wxString js("src = \"https://unpkg.com/leaflet@1.7.1/dist/leaflet.js\" integrity = \"sha512-XQoYMqMTK8LvdxXYG3nZ448hOEQiglfqkJs1NOQV44cWnUrBc8PkAOcXy20w0vlaXaVUearIOBhiXZ5V3ynxwA==\" crossorigin = \"\"; \
");/*        var map = L.map('map', { \
...
'Imagery' :\
    L.tileLayer.wms('http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}', {\
layers: 'Imagery'\
    }\
};\
...
//    frame->GetBrowser()->RunScript(wxString("L.marker([17.0, 58.0]).addTo(map); "));
    //wxLogMessage("js = %s", js);
    //frame->GetBrowser()->RunScript(js);
